        ...
        <div className='mt-12 flex p-4  mx-auto lg:w-[40%] md:w-[70%] sm:w-[90%] gap-8 flex-col'>
            ...
            <form>
                <div className='flex w-full  xl:mb-8 md:mb-6 mb-4  relative'>
                    ...
                    <input className='outline-none w-full px-8 focus:outline-none border-b-2 border-b-black' placeholder='Your Name' type='text' />
                </div>
                <div className='flex  xl:mb-8 md:mb-6 mb-4 w-full relative'>
                    <AiOutlineMail size={24} className='text-green-600 absolute ' />
                    <input className='outline-none w-full px-8 focus:outline-none border-b-black border-b-2' placeholder='Your Email' type='text' />
                </div>
                <div className='flex xl:mb-8 md:mb-6 mb-4  w-full relative'>
                    <RiLockPasswordFill size={24} className='text-green-600 absolute ' />
                    <input className='outline-none w-full px-8 focus:outline-none border-b-black border-b-2' placeholder='Your password' type='password' />
                </div>
