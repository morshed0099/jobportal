        ...
        <div className='container mt-14 mx-auto'>
            ...
            <form onSubmit={handelSubmit}>
                <div className='flex w-full  xl:mb-8 md:mb-6 mb-4  relative'>
                    ...
                    <input name='jobTitle' className='outline-none w-full px-8 focus:outline-none border-b-2 border-b-black' placeholder='Your Job title' type='text' />
                </div>
                ...
                <div className='flex xl:mb-8 md:mb-6 mb-4  w-full relative'>
                    ...
                    <input name='location' className='outline-none w-full px-8 focus:outline-none border-b-black border-b-2' placeholder='Your Location' type='text' />
                </div>
                <div className='flex xl:mb-8 md:mb-6 mb-4  w-full relative'>

                    <input name='conpanyName' className='outline-none w-full px-8 focus:outline-none border-b-black border-b-2' placeholder='Your CompanyName' type='text' />
                </div>
                <div className='flex xl:mb-8 md:mb-6 mb-4  w-full relative'>

                    <input name='phoneNumber' className='outline-none w-full px-8 focus:outline-none border-b-black border-b-2' placeholder='Your Phone Number' type='text' />
                </div>
                <div>
                    <textarea name='description' placeholder='type short desctipion ' className='w-full p-2 border'>

                    </textarea>
                </div>
                <select onChange={(e)=>setCategory(e.target.value)} className='p-2 border mt-4 mb-4 rounded-md' name="" id="">
                ...
                <div className='flex xl:mb-8 md:mb-6 mb-4  w-full relative'>
                    ...
                    <input name='r2' className='outline-none w-full px-8 focus:outline-none border-b-black border-b-2' placeholder='Your responsibility ' type='text' />
                </div>

                <div className='flex xl:mb-8 md:mb-6 mb-4  w-full relative'>

                    <input name='r3' className='outline-none w-full px-8 focus:outline-none border-b-black border-b-2' placeholder='Your responsibility ' type='text' />
                </div>
                <div className='flex xl:mb-8 md:mb-6 mb-4  w-full relative'>
                ...
                <div className='flex xl:mb-8 md:mb-6 mb-4  w-full relative'>
                    ...
                    <input name='r5' className='outline-none w-full px-8 focus:outline-none border-b-black border-b-2' placeholder='Your responsibility ' type='text' />
                </div>
                <div className='flex xl:mb-8 md:mb-6 mb-4  w-full relative'>
                ...
                <div className='flex xl:mb-8 md:mb-6 mb-4  w-full relative'>
                    ...
                    <input name='r6' className='outline-none w-full px-8 focus:outline-none border-b-black border-b-2' placeholder='Your responsibility ' type='text' />
                </div>
                <div className='flex xl:mb-8 md:mb-6 mb-4  w-full relative'>
                ...
                <div className='flex xl:mb-8 md:mb-6 mb-4  w-full relative'>
                    ...
                    <input name='r8' className='outline-none w-full px-8 focus:outline-none border-b-black border-b-2' placeholder='Your responsibility ' type='text' />
                </div>
                <div className='flex xl:mb-8 md:mb-6 mb-4  w-full relative'>

                    <input name='r9' className='outline-none w-full px-8 focus:outline-none border-b-black border-b-2' placeholder='Your responsibility ' type='text' />
                </div>
